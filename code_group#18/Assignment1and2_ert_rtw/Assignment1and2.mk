###########################################################################
## Makefile generated for Simulink model 'Assignment1and2'. 
## 
## Makefile     : Assignment1and2.mk
## Generated on : Fri Nov 29 23:29:09 2024
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Assignment1and2.elf
...
COMPILER_COMMAND_FILE     = Assignment1and2_comp.rsp
CMD_FILE                  = Assignment1and2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Assignment1and2.elf
...
DEFINES_STANDARD = -DMODEL=Assignment1and2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SCI.o MW_digitalIO.o mw_sdk_interface.o MW_AnalogInput.o MW_PWM.o i2c_api.o MW_I2C.o Assignment1and2.o Assignment1and2_data.o send_params.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Assignment1and2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment1and2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment1and2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Assignment1and2_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Assignment1and2_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Assignment1and2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment1and2.o : $(START_DIR)/Assignment1and2_ert_rtw/Assignment1and2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Assignment1and2_data.o : $(START_DIR)/Assignment1and2_ert_rtw/Assignment1and2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


send_params.o : $(START_DIR)/Assignment1and2_ert_rtw/send_params.c
	$(CC) $(CFLAGS) -o "$@" "$<"
