...
## 
## Makefile     : test.mk
## Generated on : Tue Nov 26 19:47:51 2024
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/SFW_3K04/Pacemaker/simulink_group\#18
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
OBJS = MW_SCI.o MW_digitalIO.o mw_sdk_interface.o send_params.o test.o test_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
send_params.o : $(START_DIR)/test_ert_rtw/send_params.c
	$(CC) $(CFLAGS) -o "$@" "$<"
