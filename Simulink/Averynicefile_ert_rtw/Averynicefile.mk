###########################################################################
## Makefile generated for Simulink model 'Averynicefile'. 
## 
## Makefile     : Averynicefile.mk
## Generated on : Wed Oct 23 12:00:26 2024
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Averynicefile.elf
...
COMPILER_COMMAND_FILE     = Averynicefile_comp.rsp
CMD_FILE                  = Averynicefile.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Averynicefile.elf
...
DEFINES_STANDARD = -DMODEL=Averynicefile -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o Averynicefile.o Averynicefile_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Averynicefile_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Averynicefile_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Averynicefile_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Averynicefile_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Averynicefile_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Averynicefile_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Averynicefile.o : $(START_DIR)/Averynicefile_ert_rtw/Averynicefile.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Averynicefile_data.o : $(START_DIR)/Averynicefile_ert_rtw/Averynicefile_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
