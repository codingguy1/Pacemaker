###########################################################################
## Makefile generated for Simulink model 'Peacemaker'. 
## 
## Makefile     : Peacemaker.mk
## Generated on : Wed Oct 23 16:01:38 2024
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Peacemaker.elf
...
COMPILER_COMMAND_FILE     = Peacemaker_comp.rsp
CMD_FILE                  = Peacemaker.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Peacemaker.elf
...
DEFINES_STANDARD = -DMODEL=Peacemaker -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o Peacemaker.o Peacemaker_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Peacemaker_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Peacemaker_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Peacemaker_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Peacemaker_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Peacemaker_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Peacemaker_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Peacemaker.o : $(START_DIR)/Peacemaker_ert_rtw/Peacemaker.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Peacemaker_data.o : $(START_DIR)/Peacemaker_ert_rtw/Peacemaker_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
